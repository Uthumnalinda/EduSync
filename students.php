<?php
// Student directory management page
        ...
        <div class="table-filter-bar">
            <form action="students.php" method="GET" class="search-filter-group">
                <div style="position: relative; flex: 1;">
                    ...
                    <input type="text" name="search" class="filter-input" placeholder="Search student name or code..." value="<?php echo htmlspecialchars($search); ?>">
                </div>
